...
-- Create monthly partitions (6 months back + 3 months forward)
-- Oct 2025 through Jul 2026
CREATE TABLE IF NOT EXISTS fills_2025_10 PARTITION OF fills
    FOR VALUES FROM (1727740800000) TO (1730419200000);
CREATE TABLE IF NOT EXISTS fills_2025_11 PARTITION OF fills
    FOR VALUES FROM (1730419200000) TO (1733011200000);
CREATE TABLE IF NOT EXISTS fills_2025_12 PARTITION OF fills
    FOR VALUES FROM (1733011200000) TO (1735689600000);
CREATE TABLE IF NOT EXISTS fills_2026_01 PARTITION OF fills
    FOR VALUES FROM (1735689600000) TO (1738368000000);
CREATE TABLE IF NOT EXISTS fills_2026_02 PARTITION OF fills
    FOR VALUES FROM (1738368000000) TO (1740787200000);
CREATE TABLE IF NOT EXISTS fills_2026_03 PARTITION OF fills
    FOR VALUES FROM (1740787200000) TO (1743465600000);
CREATE TABLE IF NOT EXISTS fills_2026_04 PARTITION OF fills
    FOR VALUES FROM (1743465600000) TO (1746057600000);
CREATE TABLE IF NOT EXISTS fills_2026_05 PARTITION OF fills
    FOR VALUES FROM (1746057600000) TO (1748736000000);
CREATE TABLE IF NOT EXISTS fills_2026_06 PARTITION OF fills
    FOR VALUES FROM (1748736000000) TO (1751328000000);
CREATE TABLE IF NOT EXISTS fills_2026_07 PARTITION OF fills
